...
import { SUB_CATEGORY_LIST } from "@/pages/api/UseApi";

interface SubCategoryRow extends Record<string, any> {
  id: number | string;
...
const SubCategory: React.FC = () => {
  ...
  const [subCategoryData, setSubCategoryData] = useState<SubCategoryRow[]>([]);
  ...
  useEffect(() => {
    const fetchCategory = async () => {
      try {
        ...
        const response: any = await SUB_CATEGORY_LIST();
